...
public class VisionSampleProject2014 extends SimpleRobot {
    ...
    public void robotInit() {
        camera = AxisCamera.getInstance("10.33.60.11");  // get an instance of the camera
    ...
    public void operatorControl() {
        ...
        while (isOperatorControl()&& isEnabled()) {
            if (j1.getRawButton(2)) {
                try {
                    /**
                     * Do the image capture with the camera and apply the
                     * algorithm described above. This sample will either get
                     * images from the camera or from an image file stored in
                     * the top level directory in the flash memory on the cRIO.
